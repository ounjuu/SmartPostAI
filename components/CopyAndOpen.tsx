...
export default function CopyAndOpen({ title, content, tistoryTitle, tistoryContent }: CopyAndOpenProps) {
    ...
    <div className="space-y-3">
      ...
      <div className="flex gap-2">
        <button
          ...
          className="flex-1 py-3 bg-white border border-gray-200 text-gray-700 text-sm font-medium rounded-xl hover:bg-gray-50 transition-colors"
        >
